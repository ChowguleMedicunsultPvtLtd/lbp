...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests().antMatchers("/", "/list").access("hasRole('USER') or hasRole('ADMIN') or hasRole('DBA')")
                ...
                .antMatchers("/newpatient/**").access("hasRole('USER') or hasRole('ADMIN')")
                .antMatchers("/userTypeMaster/**").access(" hasRole('ADMIN')")
                .antMatchers("/departmentType").access("hasRole('ADMIN')")

...
<html lang="en">
    <head>
        ...
        <script>
            function test(){
                ...
                if(typeField === ("")){
                    alert("Tag Type Can Not Be Blank");
                    return false;
                }
            }
        </script>
    ...
    <body class="formSec">
        ...
        <div class="container-fluid">
            <form:form modelAttribute="tag" action="tag" class="form-horizontal" method="POST">
                ...
                <div class="row ">
                    ...
                    <div class="col-md-10 col_right"> 
                        <div class="secHeading">
                            <div class="userTag">
                                <div class="userlogo" style="padding:4px 5px;"> <img src="<c:url value='/static/images/tag_40.png' />"></div>
                                <span>Tag Master</span>
                                <div class="profileSec">
                                    <div class="userTag">
                                        <div class="prflImg">
                                            <div class="inrR">
                                                <img src="<c:url value='/static/images/title1.png' />" class="prfPic">
                                            </div>
                                        </div>
                            ...
                            <div class="row setRow">
                                    ...
                                    <div class="formFill">
                                        <div class="setBox ">
                                            <div class="form-group myF_Control">
                                                <label for="exampleInputEmail1">Tag Name : </label><span>*</span>
                                ...
                                <div class="col-md-4">
                                    <div class="formFill">
                                        <div class="setBox ">
                                            <div class="form-group myF_Control">
                                                <label for="exampleInputEmail1">Assign Tag : </label>
                                                <form:input path="assignTag" class="form-control" id="assignTag"/>
                                                <div class="has-error">
                                                    <form:errors path="assignTag" class="help-inline"/>
                                                </div>
                                            </div>						  
                                        </div>
                                    </div>		
                                ...
                                <div class="col-md-8">
                                    <c:choose>
						<c:when test="${edit}">
                                                    <input type="submit" onclick="return test()" style=" margin: 31px auto auto;" value="Update"  class="btn btn-primary"/> <span class="cancelBtn">or <a href="<c:url value='/tag' />">Cancel</a></span>
                                                </c:when> 
						<c:otherwise>
                                                    <input type="submit" onclick="return test()" style=" margin: 31px auto auto;" value="Submit" class="btn btn-primary"/> <span class="cancelBtn">or <a href="<c:url value='/tag' />">Cancel</a></span>
                                                </c:otherwise>
                                    </c:choose>    
                                </div>
                                            ...
                                            <table class="table table-bordered table-hover">
                                                ...
                                                <tr>
                                                    <c:forEach items="${tagList}" var="tag">
                                                        ...
                                                        <td>${tag.assignTag}</td>
                                                    <sec:authorize access="hasRole('ADMIN') or hasRole('DBA')">
                                                        <td class="text-center"><a href="<c:url value='/edit-tag-${tag.id}' />" class="btn "><img src="<c:url value='/static/images/edit.png'/>"/></a></td>
                                                    </sec:authorize>
                                                    <sec:authorize access="hasRole('ADMIN')">
                                                        <td class="text-center"><a href="<c:url value='/delete-tag-${tag.id}' />" class="btn"><img src="<c:url value='/static/images/delete.png'/>"/></a></td>
                                                    </sec:authorize>
                                                    </tr>
                                                </c:forEach>
                                            </table>

		...
		<div class="">
							...
							<div class="userTag">
								<div class="profileSec">
									<div class="userTag">
										...
										<div class="userlogo userLogoR"> <img src="<c:url value='/static/images/drugs.png'/>"></div>
									</div>
								</div>
							</div>
 		...
 		<div class="container-fluid">
                ...
                <div class="col-md-10 col_right"> 
                    <span class="listIcon">
                       <a href="<c:url value='/drug'/>"><img src="<c:url value='/static/images/new-user.png'/>"></a>
                    </span>
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tr>
                                    <c:forEach items="${druglist}" var="drug">
                                        <td>${drug.diagnosisName}</td>
                                        <td>${drug.dosageForm}</td>
                                        <td>${drug.brandName}</td>
                                        <td>${drug.company}</td>
                                        <td>${drug.division}</td>
                                    <sec:authorize access="hasRole('ADMIN') or hasRole('DBA')">
                                        <td class="text-center"><a href="<c:url value='/edit-drug-${drug.drugSSO}' />" class="btn "><img src="<c:url value='/static/images/edit.png'/>"/></a></td>
                                    </sec:authorize>
                                    <sec:authorize access="hasRole('ADMIN')">
                                        <td class="text-center"><a href="<c:url value='/delete-drug-${drug.drugSSO}' />" class="btn"><img src="<c:url value='/static/images/delete.png'/>"/></a></td>
                                    </sec:authorize>
                                    </tr>
                                </c:forEach>
                            </table>
